...
* `chess_app/app.py`: Главный класс приложения и жизненный цикл.
* `chess_app/ui.py`: Построение интерфейса, отрисовка доски, панели и визуальные элементы.
* `chess_app/game.py`: Работа с партиями, загрузка PGN/FEN/URL, график, статус игры.
* `chess_app/interaction.py`: Взаимодействие пользователя с доской, ходы, анимации, аннотации.
* `chess_app/analysis.py`: Анализ позиции и партии, обновление таблицы лучших ходов.
